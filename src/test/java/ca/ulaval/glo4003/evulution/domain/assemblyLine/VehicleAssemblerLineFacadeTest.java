...
public class VehicleAssemblerLineFacadeTest {
    ...
    @BeforeEach
    public void setUp() {
        vehicleAssemblyLineFacade = new VehicleAssemblyLineFacade();
    }
    ...
    @Test
    public void givenNewVehicleCommandThatIsAdvanced_whenGetStatus_thenAssemblyStatusIsReceived() {
        // given
        givenNewVehicleCommand();
    ...
    private void givenNewVehicleCommand() {
        ...
        vehicleAssemblyLineFacade.configureAssemblyLine(PRODUCTION_TIME_BY_VEHICLE_TYPE);
